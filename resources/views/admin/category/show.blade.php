...
<div class="container">
        ...
        <div class="card card-primary card-outline">
                <h3 class="list-group-item">Category: {{$category->title}}</h3>
                <h4 class="list-group-item">Created: <a class="float-right">{{ $category->created_at->format('j M Y, g:i a') }}
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4 mb-4">
                        <div class="card text-dark card-has-bg click-col" style="background-image:url('{{url('storage/'. $post->image)}}');">
                            ...
                            <div class="card-img-overlay d-flex flex-column">
                              <small class="card-meta mb-2">{{$post->category->title}}</small>
                              <div class="card-body">
