        ...
        <form method="POST" action="{{route('admin.products.store')}}" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="form-check">
                  <input class="form-check-input" type="radio" name="published" id="published_true" value="1" {{ old('published', $product->published ?? false) ? 'checked' : '' }}>
                  <label class="form-check-label" for="published_true">Published</label>
              </div>
              <div class="form-check">
                  <input class="form-check-input" type="radio" name="published" id="published_false" value="0" {{ old('published', $product->published ?? false) ? '' : 'checked' }}>
                  <label class="form-check-label" for="published_false">Not Published</label>
              </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                 <div class="custom-file">
                    <input type="file" class="custom-file-input" style="cursor: pointer;" name="fileName" value="{{old('fileName')}}" id="fileName">
